                ...
                <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-6)' }}>
                        ...
                        <div style={{ display: 'flex', gap: 'var(--spacing-2)' }}>
                            <Link to="/addresses" className="btn btn-outline" style={{ fontSize: 'var(--font-size-xs)', textDecoration: 'none' }}>
                                Manage Addresses
                            </Link>
                            <Link to="/payment-methods" className="btn btn-outline" style={{ fontSize: 'var(--font-size-xs)', textDecoration: 'none' }}>
                                Payment Methods
                            </Link>
                            <Link to="/orders" className="btn btn-outline" style={{ fontSize: 'var(--font-size-xs)', textDecoration: 'none' }}>
                                My Orders
                            </Link>
                            {!isEditing && (
                                <button
